...
const leccionesData: Record<string, Record<string, LeccionData>> = {
  '1': {
    '1-1': {
      id: '1-1',
      cursoId: '1',
      cursoTitulo: 'Gestión de Reservas y Documentación',
      numero: '1.1',
      titulo: 'Proceso Completo de Reserva',
      tipo: 'video',
      duracion: 6,
      descripcion: 'Aprende el proceso completo de gestión de reservas desde la cotización hasta la confirmación.',
    ...
    return (
      <div className="leccion-page">
        <div className="leccion-page__error">
          ...
          <Button onClick={() => router.push('/academia/operacion')}>
            Volver a Operación & Soporte
          </Button>
        </div>
      </div>
    );
    ...
    <div className="leccion-page">
      <div className="leccion-page__header">
        <button
          ...
          onClick={() => router.push('/academia/operacion')}
        >
        ...
        <div className="leccion-page__header-info">
          <span className="leccion-page__header-categoria">Operación & Soporte</span>
